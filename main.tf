...
resource "azurerm_application_gateway" "app_gateway" {
  ...
  dynamic "http_listener" {
    ...
    content {
      ...
      frontend_ip_configuration_name = coalesce(http_listen.value.frontend_ip_configuration_name, var.appgw_private ? var.frontend_private_ip_configuration_name : var.frontend_ip_configuration_name)
