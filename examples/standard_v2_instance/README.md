...
| <a name="input_resource_names_map"></a> [resource\_names\_map](#input\_resource\_names\_map) | A map of key to resource\_name that will be used by tf-launch-module\_library-resource\_name to generate resource names | <pre>map(object(<br/>    {<br/>      name       = string<br/>      max_length = optional(number, 60)<br/>    }<br/>  ))</pre> | <pre>{<br/>  "app_gateway": {<br/>    "max_length": 60,<br/>    "name": "appgw"<br/>  },<br/>  "public_ip": {<br/>    "max_length": 60,<br/>    "name": "pip"<br/>  },<br/>  "resource_group": {<br/>    "max_length": 60,<br/>    "name": "rg"<br/>  },<br/>  "vnet": {<br/>    "max_length": 24,<br/>    "name": "vnet"<br/>  }<br/>}</pre> | no |
| <a name="input_address_space"></a> [address\_space](#input\_address\_space) | Address space of the Vnet | `list(string)` | n/a | yes |
| <a name="input_subnet_names"></a> [subnet\_names](#input\_subnet\_names) | Name of the subnets to be created | `list(string)` | n/a | yes |
| <a name="input_subnet_prefixes"></a> [subnet\_prefixes](#input\_subnet\_prefixes) | The CIDR blocks of the subnets whose names are specified in `subnet_names` | `list(string)` | n/a | yes |
| <a name="input_sku"></a> [sku](#input\_sku) | The SKU of the Application Gateway. Possible values are: Standard\_v2 or WAF\_v2. | `string` | n/a | yes |
...
| <a name="input_private_ip_address"></a> [private\_ip\_address](#input\_private\_ip\_address) | The private IP address of the Application Gateway. Must be within the range of the subnet | `string` | n/a | yes |
